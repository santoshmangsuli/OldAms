...
public class ResourceRepositoryImpl_JPA_Test
{
	...
	{
		resourceRepo.createResource(res);

		List<Resource> resourceList = resourceRepo.findAllResources();
		System.out.println(" bookList " + resourceList.size());
	}
	/*
