...
public class ManageServiceUsageImplTest
{
	static ApplicationContext		ctx;
	@Autowired
	public static ManageServiceUsage	msu;
	...
	public static void main(String args[])
	{
		...
		billDTO.setBillPeriodToDate(formatter.format(new Date()));
		...
		// msu.registerServiceUsage(14, srvcCode, duration);
